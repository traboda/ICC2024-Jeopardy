...
increment_byte:
    ...
    add ax, userPassword    ; Adjust AX by the address of userPassword
...
; Pad first sector to exactly 510 bytes, then add boot signature
times 510-($-$$) db 0x90
dw 0xAA55

; Second sector starts here (this will be at offset 512 in the file)
sector2:
    db "icc{b00ts3ct0rs_are_n0ic3_3rtk3p5}"  ; Secret message
    times 512-($-sector2) db 0   ; Pad the rest of sector 2
